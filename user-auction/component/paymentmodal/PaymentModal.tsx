            ...
            <div className="relative">
                ...
                <div className="p-8">
                    <div className="flex items-center gap-4 mb-3">
                        <img src={item.image ? `${process.env.NEXT_PUBLIC_CLOUD_DOMAIN}/${process.env.NEXT_PUBLIC_CLOUD_NAME}/image/upload/${images[0]}.jpg` : "/fallback-image.jpg"} alt={item.name} className="w-15 h-15 object-cover rounded-lg" />
                        <div>
